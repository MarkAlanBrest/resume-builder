...
task1: limit(clean(ai.task1), 300),
task2: limit(clean(ai.task2), 300),
task3: limit(clean(ai.task3), 300),
task4: limit(clean(ai.task4), 300),
task5: limit(clean(ai.task5), 300),
    };
  }),
