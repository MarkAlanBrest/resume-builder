...
===== PROGRAM: Building Construction Technology — Certificate in Building Construction Technology =====
...
This certificate program trains students for entry-level construction roles through hands-on instruction in building methods, jobsite safety, framing, interior finishes, and basic residential construction practices.
...
- Basic plumbing and electrical concepts
...
- Follow jobsite safety procedures
- Measure, cut, and assemble building materials
- Apply basic building trade practices
...
- Ladders and jobsite safety equipment

--- Program-Specific Project Examples ---

Use when the student has limited work history or strong hands-on experience:

- Framed walls or structural components using layout measurements
- Installed drywall, trim, or interior finish materials
- Read basic construction drawings to support project tasks
- Used hand and power tools to cut, fasten, and assemble materials
- Followed jobsite safety procedures while completing construction labs

--- Program-Specific Certifications ---

Include only if earned:

- Any student-provided OSHA, safety, or construction certifications

--- Summary Keywords for Building Construction Technology Students ---

Construction, Framing, Tools, Blueprint reading, Drywall, Safety, Layout, Building materials
...
===== PROGRAM: Combination Welding — Certificate in Combination Welding =====
...
This certificate program provides hands-on welding training for entry-level welding and fabrication roles. Training emphasizes multiple welding processes, material preparation, blueprint reading, safety, and weld quality.
...
- Perform common welding processes
- Prepare and fit metal for welding
- Read basic welding symbols and drawings
- Use cutting and grinding equipment safely
- Inspect welds for visible defects
- Follow welding safety procedures
...
- SMAW, GMAW, and FCAW welding equipment
- Welding helmets and PPE
- Grinders
- Oxy-fuel or plasma cutting equipment
...
- Completed welds using multiple welding processes
- Prepared metal surfaces and joints for welding
- Interpreted basic drawings or weld symbols for shop assignments
- Used grinders and cutting tools to support fabrication work
- Checked welds for consistency, penetration, and visible defects
...
- Any student-provided welding certifications

--- Summary Keywords for Combination Welding Students ---

Welding, Fabrication, SMAW, GMAW, FCAW, Blueprint reading, Safety, Metal preparation
...
===== PROGRAM: Electrical Technology — Certificate in Electrical Technology =====
...
This certificate program trains students for entry-level electrical work through hands-on instruction in wiring, circuits, electrical safety, troubleshooting, blueprint reading, and installation practices.
...
- Install basic electrical circuits
- Read wiring diagrams and electrical drawings
- Use meters and testing equipment
...
- Installed wiring, outlets, switches, or lighting circuits
- Bent conduit and pulled wire for lab projects
- Used multimeters to test circuits and troubleshoot electrical issues
- Read wiring diagrams to complete installation tasks
- Applied electrical safety practices during hands-on training
...
- Any student-provided electrical or safety certifications

--- Summary Keywords for Electrical Technology Students ---

Electrical, Wiring, Circuits, Conduit, Troubleshooting, Safety, Blueprint reading, Installation
...
- Attention to detail
- Tool use
- Installation and troubleshooting tasks
- Ability to follow diagrams or instructions



===== PROGRAM: HVAC (HRVAC) Technology — Certificate in HVAC Technology =====

This program block applies ONLY when the student's selected program exactly matches:
"HVAC (HRVAC) Technology — Certificate in HVAC Technology"

--- Program Purpose ---

This certificate program trains students for entry-level heating, ventilation, air conditioning, and refrigeration work. Training emphasizes HVAC/R installation, service, electrical troubleshooting, refrigerant handling, and safe work practices.
...
- Install and service HVAC/R components
- Perform refrigerant recovery, evacuation, and charging
- Troubleshoot basic electrical and mechanical faults
- Read HVAC/R schematics and wiring diagrams
- Use HVAC/R service tools safely
...
- Vacuum pumps
- Multimeters
- Thermometers and leak detectors
- Brazing equipment
...
- Recovered, evacuated, and charged refrigerant systems
- Diagnosed HVAC/R electrical or mechanical faults
- Completed brazing, piping, or component installation tasks
- Read wiring diagrams and HVAC/R schematics for troubleshooting
- Performed preventive maintenance on heating or cooling equipment
...
--- Summary Keywords for HVAC Technology Students ---

HVAC/R, Refrigeration, Heating, Air conditioning, Electrical troubleshooting, Installation, Service, Maintenance
...
===== PROGRAM: Diesel Technology — Certificate in Diesel Technology =====
...
This certificate program trains students for entry-level diesel service and repair roles. Training emphasizes diesel engine systems, electrical troubleshooting, preventive maintenance, brake and suspension service, and safe shop practices.
...
- Perform diesel engine maintenance and basic repair
- Troubleshoot electrical and mechanical issues
- Inspect brake, suspension, and powertrain components
- Use service information and diagnostic tools
- Complete preventive maintenance procedures
- Follow shop safety standards
...
- Performed diesel preventive maintenance inspections
- Diagnosed basic engine, electrical, or powertrain concerns
- Serviced brakes, suspension, fluids, or filters
- Used service manuals to complete repair procedures
- Applied safe shop practices while working around diesel equipment
...
- Any student-provided diesel, safety, or equipment certifications

--- Summary Keywords for Diesel Technology Students ---

Diesel, Diagnostics, Preventive maintenance, Electrical troubleshooting, Brakes, Suspension, Service manuals, Shop safety
...
===== PROGRAM: Commercial Truck Driving — Certificate in Commercial Truck Driving + CDL License =====

This program block applies ONLY when the student's selected program exactly matches:
"Commercial Truck Driving — Certificate in Commercial Truck Driving + CDL License"

--- Program Purpose ---

This certificate program prepares students for entry-level commercial driving roles through classroom instruction, vehicle inspection practice, backing maneuvers, road driving, safety procedures, and CDL preparation.

--- Core Focus Areas ---

- CDL knowledge and skills preparation
...
- Perform backing and maneuvering exercises
- Follow DOT and FMCSA requirements
- Manage trip planning and driving documentation
...
- Logbook or ELD concepts
- Coupling equipment
- Safety triangles and basic inspection tools
...
- Practiced backing, turning, and maneuvering commercial vehicles
- Coupled and uncoupled tractor-trailer equipment
- Applied defensive driving and road safety practices
- Reviewed DOT compliance, trip planning, and documentation requirements
...
- Class A CDL License
- Any student-provided transportation or safety certifications

--- Summary Keywords for Commercial Truck Driving Students ---

CDL, Commercial driving, Vehicle inspection, Safety, DOT compliance, Trip planning, Defensive driving, Tractor-trailer
...
- Driving or equipment operation experience
`;
