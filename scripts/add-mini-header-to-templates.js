/**
 * Adds a floating top-right textbox overlay on page 2+ via an empty first-page footer.
 * Does not use Word headers. The textbox is page-anchored and does not shift body content.
...
function stripHeadersAndBodyOverlay(zip) {
...
function patchTemplate(filePath) {
  ...
  stripHeadersAndBodyOverlay(zip);
